...
function showName(){
	...
	createPoint(x[i].getElementsByTagName("NAME")[0].childNodes[0].nodeValue, parseFloat(x[i].getElementsByTagName("LNG")[0].childNodes[0].nodeValue), parseFloat(x[i].getElementsByTagName("LAT")[0].childNodes[0].nodeValue), placemark[i], now_houseAgency);	
			count++;
			}	
		if(count>=20)
			break;
