...
public class BorderDemo extends JPanel {
	public BorderDemo() {
		...
		titled = BorderFactory.createTitledBorder("titleGG");
		...
		tabbedPane.addTab("Main", null, simpleBorders, null);
		tabbedPane.addTab("Nutch", null, matteBorders, null);
		tabbedPane.addTab("Solr", null, titledBorders, null);
		tabbedPane.addTab("System", null, compoundBorders, null);
